...
- http://127.0.0.1:8000/api/users/(id od user-a)/ - GET i PUT zahtjevi, PUT zahtjev prihvata is_active kao podatak i mijenja ga u true ili false. Ukoliko se proslijedi drugi parametar vraca se greska u odgovoru.